...
[
    ...
    <ol>
        <li>La società consociata Google che offre i servizi, tratta le tue informazioni ed è responsabile del rispetto delle leggi sulla privacy vigenti. Generalmente Google offre i propri servizi per i consumatori tramite una delle due società seguenti:
            <ul><br> <li>Google Ireland Limited, se gli utenti sono residenti nello Spazio economico europeo (paesi dell\Unione europea, oltre a Islanda, Liechtenstein e Norvegia) o in Svizzera.</li>
            <br><li>Google LLC, con sede negli Stati Uniti, per il resto del mondo.</li>
            </ul> 
        </li>
        <br><li>La versione dei termini che regola il nostro rapporto, che può variare in base alle leggi locali.</li>
    </ol>
...
echo "<h2>" .  $domrisp['question'] . "</h2>";
echo "<p>" . $domrisp['answer'] . "</p>";
